...
<Note> This integration is for the **Respan gateway**. For workflow tracing, see [Haystack Tracing](/integrations/development-frameworks/tracing/haystack). </Note>

## Overview

Haystack is an open-source framework for building LLM applications with composable pipelines. The Respan gateway integration routes your LLM calls through Respan for automatic logging, fallbacks, load balancing, and cost optimization.
...
<Card title="Haystack Tracing Integration" href="/integrations/development-frameworks/tracing/haystack" icon="link">
