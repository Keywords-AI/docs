...
### Respan params
You can pass any [Respan observability parameters](https://docs.respan.ai/apis/develop/gateway/chat-completions#observability-parameters) in the `metadata` field.
