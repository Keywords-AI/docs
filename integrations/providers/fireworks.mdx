...
<Card title="Get Started with Logging" icon="rocket" href="/documentation/features/observability/logs/quickstart"> Learn how to set up comprehensive logging for all your LLM requests </Card>
