...
You can find the full source code for this example on GitHub: [TypeScript Example](https://github.com/Respan/respan-example-projects/blob/main/example_scripts/typescript/vercel_sdk_example.ts)
