...
- [Python Example](https://github.com/Respan/respan-example-projects/blob/main/example_scripts/python/gemini/gemini_sdk_example.py)
- [TypeScript Example](https://github.com/Respan/respan-example-projects/blob/main/example_scripts/typescript/gemini_sdk_example.ts)
