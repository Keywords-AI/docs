...
- **Limited Gateway Features**: You can't use features like [user rate limits](/documentation/features/observability/customer-identifier#rate-limits), [fallbacks](/documentation/features/llm-gateway/advanced-configuration#fallback-models) or [load balancing](/documentation/features/llm-gateway/advanced-configuration#load-balancing). 
