...
Use the Respan [Langfuse](https://langfuse.com/) instrumentor to redirect Langfuse traces to Respan without changing your Langfuse usage. You can keep using `@observe` and the Langfuse SDK as usual.
