...
### Video logging
You can now log videos in Respan. Video file like `mp4`, `mov`, `wmv`, `avi`, etc. are supported in Logs, Playground, Prompts, and Experiments.
...
You can see the definition and classification of the log type [here](/documentation/getting-started/observability_data_model#log-types).
...
## New
### Respan 2025 Wrapped is here!
We just launched Respan 2025 Wrapped - a summary of your usage in 2025. 

You can see your total usage, top prompts, top users, and more. Check it out [here](https://platform.respan.ai/platform/2025).
<Frame className="rounded-md">
...
You can now call your custom models in the Playground. Add custom models through Respan  Models page and call them through LLM gateway and Playground.
<Frame className="rounded-md">
...
Respan now supports Gemini 3 Flash across the product, including the LLM Gateway, Playground, Prompts, and Experiments.
