...
- **[Use prompt in code](/documentation/features/prompt-management/use-prompt)**: reference your prompt by ID in code. When you deploy a new version on the platform, your application picks it up immediately with no code changes.
