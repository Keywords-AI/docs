...
Using a framework like OpenAI Agents SDK or Vercel AI SDK? See [Integration frameworks](/documentation/features/observability/traces/integration-frameworks) for pre-built integrations.

For advanced SDK features (class-based workflows, override span I/O), see [Tracing SDK](/documentation/features/observability/traces/tracing-sdk).
...
See [Manual ingestion](/documentation/features/observability/traces/manual-ingestion) for full details.
