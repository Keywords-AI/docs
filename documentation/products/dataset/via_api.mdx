...
If you want the raw endpoint specs, see the [Datasets API reference](/apis/evaluate/datasets/list). This page is the **workflow**.
...
- [Datasets API reference](/apis/evaluate/datasets/list)
...
Reference: [Create dataset](/apis/evaluate/datasets/create)
...
Reference: [Create dataset log](/apis/evaluate/datasets/logs-create)
...
Reference: [List logs (GET)](/apis/evaluate/datasets/logs-list)
...
Reference: [Run eval on dataset](/apis/evaluate/datasets/eval-reports-create)
...
Reference: [List eval runs](/apis/evaluate/datasets/eval-reports-list)
...
Reference: [Create dataset with specified logs](/apis/evaluate/datasets/create-with-logs)
...
Reference: [Add logs to dataset (bulk)](/apis/evaluate/datasets/logs-add)
...
Reference: [Update dataset (PATCH)](/apis/evaluate/datasets/patch)
...
Reference: [Delete logs (filters / delete-all)](/apis/evaluate/datasets/logs-remove)
...
Reference: [Delete dataset](/apis/evaluate/datasets/delete)
