...
description: "You can send your prompt variables to Respan to log them in your logs. So you can see the prompt template and variables separately"
---
<Frame>
<video
  controls
...
### Via LLM Gateway
If you are using the [LLM Gateway](/documentation/getting-started/quickstart/gateway), you should first [set up your prompts](/documentation/products/prompt_management/use_prompt_in_code/use_prompt_in_llms) in the code. Then we will log the LLM requests and variables automatically.

**Example:**
When you created a prompt like this:
<Frame>
<img src="https://keywordsai-static.s3.us-east-1.amazonaws.com/docs/prompt-example.png" alt="Sample prompt in Respan" />
</Frame>
...
When you make a request through the [Logging ingestion](/apis/observe/logs/request-logging-endpoint), you can send the prompt variables in the `prompt_messages` field. Just simply wrap your prompt variables in pairs of `{{}}`.
