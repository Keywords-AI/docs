...
- An evaluator (either a Respan evaluator or your custom evaluator)
...
The Scores API allows you to programmatically manage scores. See the [API Reference](/apis/evaluate/scores) for detailed documentation.
...
url = f"https://api.respan.ai/api/logs/{log_id}/scores/"
headers = {
...
Scores are visible in the log details view in the Respan dashboard. You can:
