...
Choose models that support thinking like `gpt-5`, `claude-sonnet-4-20250514`. See the [Log Thinking](/documentation/features/observability/logs/log-content-types#thinking-blocks) documentation for details on the response structure.
