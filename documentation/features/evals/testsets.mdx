...
**Add test cases from logs** — if your logs contain [prompt variables](/documentation/features/prompt-management/use-prompt), you can add them directly to a testset. Click a log with variables, then click the **+** button to add it to a testset.
