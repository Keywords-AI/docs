...
See [Tracing parameters](/documentation/features/tracing/traces/span-parameters) for all available fields. For framework setup, see [Integration frameworks](/integrations/overview#agent-frameworks).
...
See [AI gateway](/documentation/getting-started/quickstart/gateway) for full setup.
