...
**Views** are saved filter configurations. When you apply filters on [Logs](/documentation/features/observability/logs/quickstart), [Traces](/documentation/features/observability/traces/quickstart), [Users](/documentation/features/observability/customer-identifier), [Prompts](/documentation/features/prompt-management/quickstart), or elsewhere in Respan—for example, by `status`, `model`, `user`, `timestamp`, or [custom properties](/documentation/features/observability/logs/log-parameters#custom-properties)—you can save that filter setup as a **view**. Views let you reuse the same filters with one click instead of reconfiguring them each time.
...
<CardGroup cols={2}>
<Card title="Logs quickstart" href="/documentation/features/observability/logs/quickstart">
Get started with logging and filtering LLM requests.
</Card>

<Card title="Traces quickstart" href="/documentation/features/observability/traces/quickstart">
