...
See [Log fields & parameters](/documentation/features/observability/logs/log-parameters) for all available fields.
...
See [Tracing parameters](/documentation/features/observability/traces/span-parameters) for all available fields. For framework setup, see [Integration frameworks](/documentation/features/observability/traces/integration-frameworks).
