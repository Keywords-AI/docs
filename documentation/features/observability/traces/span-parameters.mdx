...
Every span is a [log](/documentation/features/observability/logs/quickstart) with hierarchical context. All fields available on [log fields & parameters](/documentation/features/observability/logs/log-parameters) are also available on spans. This page covers the most important trace-specific fields. For the complete list, see the [Span fields reference](/documentation/resources/reference/span-fields).
...
`string` — Unique user or customer ID. Applies to all spans in the trace. Use this to track per-user metrics, set [budgets](/documentation/features/observability/customer-identifier#budgets), and apply [rate limits](/documentation/features/observability/customer-identifier#rate-limits).
...
See [Customer identifier](/documentation/features/observability/customer-identifier) for more.
