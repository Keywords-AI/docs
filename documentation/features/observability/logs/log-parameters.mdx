...
`string` — Unique user or customer ID. Use this to track per-user metrics, set [budgets](/documentation/features/observability/customer-identifier#budgets), and apply [rate limits](/documentation/features/observability/customer-identifier#rate-limits).
