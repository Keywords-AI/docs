...
<Tip>Example project: <a href="https://github.com/respanai/respan-example-projects/tree/main/python/tracing/respan-tracing-sdk/logs-to-trace" target="_blank" rel="noopener noreferrer">Ingest traces example</a></Tip>
