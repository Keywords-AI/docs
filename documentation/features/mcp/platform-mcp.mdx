...
<Tabs>
  <Tab title="OAuth (Recommended)">
    ...
    <Steps>
      <Step title="Add the MCP server">
        ...
        claude mcp add --transport http respan https://mcp.keywordsai.co/mcp
        ```
        ...
        ```json Claude Desktop (config)
        {
          "mcpServers": {
            "respan": {
              "url": "https://mcp.keywordsai.co/mcp"
            }
          }
        }
        ```
  ...
  <Tab title="JWT Token">
    ...
    <Steps>
      <Step title="Sign in">
        Go to [mcp.keywordsai.co/login](https://mcp.keywordsai.co/login) and sign in with **Google** or **email/password**.
      </Step>
...
| **JWT Token** | Sign in at [mcp.keywordsai.co/login](https://mcp.keywordsai.co/login), copy token | Fallback when OAuth fails |
...
<AccordionGroup>
  ...
  <Accordion title="Authentication errors">
    ...
    2. **JWT Token**: Tokens expire — sign in again at [mcp.keywordsai.co/login](https://mcp.keywordsai.co/login) to get a fresh token.
