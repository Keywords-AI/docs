...
Use [webhook notifications](/documentation/features/notifications/webhooks) to get alerted when quality drops:
...
<Card title="Automations" icon="bolt" href="/documentation/features/automations/quickstart">
