...
<CardGroup cols={2}>
<Card title="Gateway setup" icon="route" href="/documentation/features/llm-gateway/setup">
  Full setup guide with all supported frameworks
</Card>
<Card title="Advanced configuration" icon="gear" href="/documentation/features/llm-gateway/advanced-configuration">
