...
Use [saved views](/documentation/features/observability/views) to create a filter for logs you want to investigate.
...
3. Set up [online evaluation](/documentation/features/automations/quickstart_online_eval) to continuously monitor the deployed version
...
<Card title="Online evaluation" icon="gauge" href="/documentation/features/automations/quickstart_online_eval">
