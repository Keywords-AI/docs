...
description: "Manage conversation logs and request/response data with the Respan Python SDK"
---
...
| Method | Description |
|--------|-------------|
| [`create()`](/sdks/python/logs/create) | Create a new log entry |
| [`list()`](/sdks/python/logs/list) | List logs with optional filtering |
| [`get()`](/sdks/python/logs/get) | Retrieve a specific log by ID |

### Asynchronous Methods

| Method | Description |
|--------|-------------|
| [`acreate()`](/sdks/python/logs/create) | Async version of create |
| [`alist()`](/sdks/python/logs/list) | Async version of list |
| [`aget()`](/sdks/python/logs/get) | Async version of get |
...
```python
from respan.exceptions import ValidationError, RateLimitError
...
- Learn how to [create logs](/sdks/python/logs/create)
- Explore [listing and filtering logs](/sdks/python/logs/list)
- Understand how to [retrieve specific logs](/sdks/python/logs/get)
