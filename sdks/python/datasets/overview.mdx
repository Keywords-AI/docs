...
description: "Manage datasets and collections of logs with the Respan Python SDK"
---
...
| Method | Description |
|--------|-------------|
| [`create()`](/sdks/python/datasets/create) | Create a new dataset |
| [`list()`](/sdks/python/datasets/list) | List all datasets |
| [`get()`](/sdks/python/datasets/get) | Retrieve a specific dataset |
| [`update()`](/sdks/python/datasets/update) | Update dataset information |
| [`delete()`](/sdks/python/datasets/delete) | Delete a dataset |

### Log Management

| Method | Description |
|--------|-------------|
| [`add_logs_to_dataset()`](/sdks/python/datasets/add-logs-to-dataset) | Add logs to a dataset |
| [`remove_logs_from_dataset()`](/sdks/python/datasets/remove-logs-from-dataset) | Remove logs from a dataset |
| [`list_dataset_logs()`](/sdks/python/datasets/list-dataset-logs) | List logs in a dataset |

### Evaluation Operations

| Method | Description |
|--------|-------------|
| [`run_dataset_evaluation()`](/sdks/python/datasets/run-dataset-evaluation) | Run evaluation on dataset |
| [`get_evaluation_report()`](/sdks/python/datasets/get-evaluation-report) | Get evaluation results |
| [`list_evaluation_reports()`](/sdks/python/datasets/list-evaluation-reports) | List all evaluation reports |
...
- Learn how to [create datasets](/sdks/python/datasets/create)
- Explore [adding logs to datasets](/sdks/python/datasets/add-logs-to-dataset)
- Understand [dataset evaluation](/sdks/python/datasets/run-dataset-evaluation)
- See [complete examples](/sdks/python/examples) for real-world usage