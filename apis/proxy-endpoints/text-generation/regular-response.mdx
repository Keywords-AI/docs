...
If you have [logprobs](/apis/proxy-endpoints/text-generation/request-params) set to true, you will receive the the logarithm of the probablity of choosing each token. This shows how confident the LLM is when generating the answer. Read more in the [concept page](/apis/proxy-endpoints/text-generation/request-params#logprobs)
