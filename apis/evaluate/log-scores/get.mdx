---
title: Retrieve span score
api: GET https://api.respan.ai/api/logs/{log_id}/scores/{score_id}/
---
...
When you retrieve span details, scores are automatically included in the response under a `scores` field. This enriched format includes:
...
Example enriched scores in a span response:
```json
{
  "id": "log_abc123",
  "model": "gpt-4",
