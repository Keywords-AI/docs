...
- **Logs Summary**: [GET/POST /api/request-logs/summary/](/apis/observe/logs/logs-summary-endpoint)
...
See the [Logs Summary endpoint](/apis/observe/logs/logs-summary-endpoint) for complete details on the score summary format.