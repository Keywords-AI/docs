...
<Note>
The same URL supports **POST** with a JSON body for complex filtering (e.g. `filters`, `page`, `page_size`). See [List spans with filters](/apis/evaluate/datasets/logs-list-post) for the POST contract.
</Note>
