---
title: List models
api: GET https://api.respan.ai/api/models/public
authMethod: "none"
---
...
<ParamField name="model_name" type="string">
    The name used in `model` parameter for calling the Respan [chat completion](/apis/develop/gateway/chat-completions) endpoint.
</ParamField>
...
<ParamField name="rate_limit" type="number">
    The rate limit for calling this model with Respan.
</ParamField>
