...
api: "GET https://api.respan.ai/api/credit-transactions/{id}/"
...
url = f"https://api.respan.ai/api/credit-transactions/{transaction_id}/"
headers = {
...
const url = `https://api.respan.ai/api/credit-transactions/${transactionId}/`;
const headers = {
    'Authorization': 'Bearer YOUR_API_KEY'
};
...
```bash cURL
curl -X GET "https://api.respan.ai/api/credit-transactions/ct_1a2b3c4d5e6f7g8h/" \
