...
api: "GET https://api.respan.ai/api/credit-transactions/list/"
...
url = "https://api.respan.ai/api/credit-transactions/list/"
headers = {
...
const url = 'https://api.respan.ai/api/credit-transactions/list/';
const headers = {
    'Authorization': 'Bearer YOUR_API_KEY'
};
...
```bash cURL
curl -X GET "https://api.respan.ai/api/credit-transactions/list/" \
