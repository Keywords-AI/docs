---
title: List thread
api: POST https://api.respan.ai/api/log_threads/
---
...
<ParamField body="filters" type="object" default={{}}>
  The filters to apply to the threads. For complete filter operators and examples, see the [Filters API Reference](/apis/reference/filters_api_reference).
...
import requests
import json
url = "https://api.respan.ai/api/log_threads/?page_size=100"
payload = json.dumps({
  "filters": {
    "thread_identifier": {
      "operator": "in",
