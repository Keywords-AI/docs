...
<Note>
For updating multiple logs at once, use the [Batch Update endpoint](/apis/observe/logs/logs-update-endpoint).
</Note>
...
<ParamField path="unique_id" type="string" required>
  The unique ID of the log to update. You can get this from the [List Logs endpoint](/apis/observe/logs/logs-list-endpoint).
</ParamField>
...
Returns the complete updated log object (same structure as the [Get Log endpoint](/apis/observe/logs/get-log-endpoint)).
...
- [Batch Update Logs](/apis/observe/logs/logs-update-endpoint) - Update multiple logs at once
- [Get Log](/apis/observe/logs/get-log-endpoint) - View log details before updating
- [List Logs](/apis/observe/logs/logs-list-endpoint) - Find logs to update using filters
