...
Same parameters as the [List Logs endpoint](/apis/observe/logs/logs-list-endpoint):
...
You can add filter parameters to the request body (same as [List Logs endpoint](/apis/observe/logs/logs-list-endpoint)):
...
See the [List Logs endpoint](/apis/observe/logs/logs-list-endpoint#url-based-filtering-quick-filters) for complete URL filtering documentation.
