---
title: Update log
api: PATCH https://api.respan.ai/api/request-logs/batch-update/
---
...
For `log_type` specifications, see [log types](/documentation/getting-started/observability_data_model#log-types).
</Note>

## Body parameters

<ParamField path="unique_id" type="string">
You can get a log's `unique_id` from the [Logs list endpoint](/apis/observe/logs/logs-list-endpoint). Then pass this `unique_id` to update the log.
```json
{
    "unique_id": "xxxxxx"
}
