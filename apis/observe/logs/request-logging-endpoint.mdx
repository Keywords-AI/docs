...
An identifier for the customer that invoked this request. Helps with visualizing user activities. See [customer identifier details](/documentation/features/observability/customer-identifier).
