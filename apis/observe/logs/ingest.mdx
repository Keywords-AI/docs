...
The system automatically extracts type-specific fields based on the `log_type`. See [log types](/documentation/getting-started/observability_data_model#log-types) for complete specifications and the [Create Log documentation](/apis/observe/logs/request-logging-endpoint) for all field details.
