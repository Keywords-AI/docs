---
title: "Ingest spans from traces"
api: "POST https://api.respan.ai/api/traces/ingest/"
---

Ingest trace data as spans. This endpoint allows you to convert trace data into span format for storage and analysis using the **universal input/output design**.

## Universal input/output support

This endpoint accepts spans with:
...
The system automatically extracts type-specific fields based on the `log_type`. See [span types](/documentation/getting-started/observability_data_model#log-types) for complete specifications and the [Create span documentation](/apis/observe/logs/request-logging-endpoint) for all field details.
