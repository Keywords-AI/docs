---
title: "Export experiment spans"
api: "GET https://api.respan.ai/api/v2/experiments/{experiment_id}/logs/?export=1"
---

Exports experiment spans to CSV/Excel format. The export is processed asynchronously and a download link is sent to your email.
...
url = f"https://api.respan.ai/api/v2/experiments/{experiment_id}/logs/"
headers = {
...
```bash cURL
curl -X GET "https://api.respan.ai/api/v2/experiments/{experiment_id}/logs/?export=1&start_time=2025-01-01T00:00:00Z&end_time=2025-01-31T23:59:59Z" \
