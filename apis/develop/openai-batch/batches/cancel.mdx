...
Returns the batch object with `cancelling` status. Poll the [retrieve batch](/apis/develop/openai-batch/batches/get) endpoint to check when cancellation completes.
