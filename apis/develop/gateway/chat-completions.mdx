...
<ParamField body="load_balance_group" type="object">
  ...
  here.](/documentation/features/llm-gateway/advanced-configuration#load-balancing)
...
<ParamField body="fallback_models" type="array">
  ...
  here.](/documentation/features/llm-gateway/advanced-configuration#fallback-models)
    <Accordion title="Example">
  ```json
{
  // ...other parameters...
...
Enable or disable caches. Check the [details of caches here.](/documentation/features/llm-gateway/advanced-configuration#caches)
<Accordion title="Example">
```json
{
    "cache_enabled": true
...
<ParamField body="retry_params" type="object">
    Enable or disable retries and set the number of retries and the time to wait before retrying. Check the [details of retries here.](/documentation/features/llm-gateway/advanced-configuration#retries)
  <Accordion title="Properties">
...
<ParamField body="disable_log" type="boolean" deafault={false}>
  ...
  metrics](/documentation/features/observability/metrics) will be recorded, input
...
This only excludes providers in the LLM router, if `model` parameter takes precedence over this parameter, and`fallback_models` and [safety net](/documentation/features/notifications/subscribe_alerts) will still use the excluded models to catch failures.
...
This only excludes models in the LLM router, if `model` parameter takes precedence over this parameter, and`fallback_models` and [safety net](/documentation/features/notifications/subscribe_alerts) will still use the excluded models to catch failures.
...
You can add any key-value pair to this metadata field for your reference. Check the [details of metadata here.](/documentation/features/observability/logs/log-parameters#custom-properties)
...
<ParamField body="customer_identifier" type="string">
  Use this as a tag to identify the user associated with the API call. See the [details of customer identifier here.](/documentation/features/observability/customer-identifier)
  <Accordion title="Example">
```json
{
    //...other_params,
