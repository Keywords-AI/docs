---
title: "Create prompt"
api: "POST https://api.respan.ai/api/prompts/"
---
...
After you created a prompt, you can create versions of the prompt by sending a POST request to the[ prompt versions endpoint](/apis/develop/prompts/create-prompt-version).
