...
api: "PATCH https://api.respan.ai/api/prompts/{prompt_id}/versions/{version}/"
---
...
<ParamField path="deploy" type="boolean">
   Whether to deploy this version as the live version. Default is `false`. A newer version must exist to deploy a previous version. For example, to deploy v2, v3 must already exist.
</ParamField>
