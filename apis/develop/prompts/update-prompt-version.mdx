...
<ParamField path="tools" type="array">
    The list of tools to use for the prompt version. Check out [tools](/documentation/features/llm-gateway/advanced-configuration#function-calling) for more information.
    <Accordion title="Example">
```json
{
"tools": [
