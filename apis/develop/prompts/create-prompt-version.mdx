...
<ParamField body="fallback_models" type="array">
    The list of fallback models for the prompt version. Check out [fallback models](/documentation/features/llm-gateway/advanced-configuration#fallback-models) for more information.
    <Accordion title="Example">
```json
{
...
<ParamField body="load_balance_models" type="array">
    The list of models to load balance the prompt version. Check out [load balancing](/documentation/features/llm-gateway/advanced-configuration#load-balancing) for more information.
    <Accordion title="Example">
```json
{
"load_balance_models": [
...
<ParamField body="tools" type="array">
    The list of tools to use for the prompt version. Check out [function calling](/documentation/features/llm-gateway/advanced-configuration#function-calling) for more information.
    <Accordion title="Example">
```json
{
"tools": [
