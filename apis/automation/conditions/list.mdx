...
api: "GET https://api.respan.ai/automation/conditions/"
---
...
```bash cURL
curl -X GET "https://api.respan.ai/automation/conditions/" \
...
```bash cURL
curl -X GET "https://api.respan.ai/automation/conditions/?page=1&page_size=10" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash cURL
curl -X GET "https://api.respan.ai/automation/conditions/?search=success&condition_type=single_log" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
