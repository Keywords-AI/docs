...
api: "GET https://api.respan.ai/api/conditions/"
---
...
```bash cURL
curl -X GET "https://api.respan.ai/api/conditions/" \
...
```bash cURL
curl -X GET "https://api.respan.ai/api/conditions/?page=1&page_size=10" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash cURL
curl -X GET "https://api.respan.ai/api/conditions/?search=success&condition_type=single_log" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
